...
public class ICGoodiebag {

    private Player player;

    public ICGoodiebag(Player player) {
        this.player = player;
    }
    ...
    public int[] rewards = {24013, 24013, 24013, 24013, 24012, 24012, 24012, 24012, 24012, 24011, 24011, 24011,
            24011, 24011, 24011, 24011, 24011, 24011, 24011, 7995};
