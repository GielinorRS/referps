            ...
            public void execute() {
                if (tick == 0) {
                    ...
                    if(selectedDrain == 0 && !PrayerHandler.isActivated(target, PrayerHandler.PROTECT_FROM_MELEE)) {
                        ...
                        target.sendMessage("Your melee stats have been weakened by the slithery monster!");
                        ...
                        target.performGraphic(DRAIN);
                        target.sendMessage("Your magic has been weakened by the slithery monster!");
                        ...
                        target.performGraphic(DRAIN);
                        target.sendMessage("Your range has been weakened by the slithery monster!");
                    }
                } else if (tick == 7) {
                    npc.setChargingAttack(false);
                    stop();
