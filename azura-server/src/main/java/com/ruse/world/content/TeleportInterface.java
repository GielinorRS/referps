...
public class TeleportInterface {
    ...
    public enum Bosses implements Teleport {
        ...
        HADES("Hades Spirit", 2949, new int[]{3036, 4003, 0}, 1800), //TODO Was malevolent bird
        //Tier Two Boss
        ...
        SKIKRUU("Shikruu", 4972, new int[]{2975, 4000, 0}, 1800), //TODO was sneaky dragon




        INFERNAL_DEMON("Death demon", 12810, new int[]{2712, 4508, 0}, 2500), //TODO //MISC Boss (update)
        CRAZY_WITCH("Slither", 1234, new int[]{2784, 4445, 0}, 1000), //TODO //MISC Boss (update)
    ...
    public enum Minigames implements Teleport {
        ...
        TH("Cursed Raids", 9816, new int[]{2553, 3715, 0}, 3000),
