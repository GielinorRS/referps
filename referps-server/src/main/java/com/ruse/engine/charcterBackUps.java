...
public class charcterBackUps {
	 ...
	 */
	private static final String INPUT_DIRECTORY = "./referps-server/data/saves/characters";
	...
	public static void startBackupService() {
		...
		try {
			zipFolder("./referps-server/data/saves/", OUTPUT_DIRECTORY + "/Character Archive [" + getTime() + "].zip");
