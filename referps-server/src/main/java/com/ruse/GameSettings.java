...
public class GameSettings {
    ...
    public static final String RSPS_NAME = "Refer-PS";
    public static final String BCRYPT_EXAMPLE_SALT = "$2a$09$kCPIaYJ6vJmzJM/zq8vuSO";
    /**
     * WEB URLS
     */
    public static final String DomainUrl = "https://Refer.io/";
    public static final String ForumUrl = "https://Refer.io/forums";
    public static final String showthreadx = "-x";
    public static final String UpdateUrl = "https://discord.gg/6sEdpd6jar";
    public static final String StoreUrl = "https://Refer.io/store";
    ...
    public static final String VoteUrl = "https://Refer.io/vote";
    public static final String PriceList = "https://Refer.gg/Jv4F7YEK9k";
    public static final String HiscoreUrl = "https://Refer.io/store";
    public static final String ReportUrl = "https://Refer.gg/Jv4F7YEK9k";
    public static final String RuleUrl = "https://Refer.gg/Jv4F7YEK9k";
    public static final String CommandsUrl =  "https://lunite.io/";
    public static final String RankFeaturesUrl = "https://discord.gg/6sEdpd6jar";
    public static final String WikiaUrl = "https://discord.gg/6sEdpd6jar";
    public static final String IronManModesUrl = "https://discord.gg/6sEdpd6jar";
    public static final String HexUrl = "www.colorpicker.com";
    public static final String DiscordUrl = "https://discord.gg/6sEdpd6jar";
    public static final String ThreadUrl = "https://discord.gg/6sEdpd6jar";
    public static final String RickRoll = "https://discord.gg/6sEdpd6jar";
    public static final String DifficultyUrl =  "https://discord.gg/6sEdpd6jar";
    public static final String STARTGUIDE = "https://discord.gg/6sEdpd6jar";
    public static final String PRICEGUIDE = "https://discord.gg/6sEdpd6jar";
    public static final String SLAYERGUIDE = "https://discord.gg/6sEdpd6jar";
