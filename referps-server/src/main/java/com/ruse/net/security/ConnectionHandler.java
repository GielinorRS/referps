...
public class ConnectionHandler {
	...
	private static final String BLACKLIST_DIR = "./referps-server/data/saves/blockedhosts.txt";
	private static List<String> BLACKLISTED_HOSTNAMES = new ArrayList<String>();

	private static final String BLACKLISTED_MACS_DIR = "./referps-server/data/saves/BannedMacs.txt";
	private static List<String> BLACKLISTED_MACS = new ArrayList<String>();

	private static final String BLACKLISTED_UUIDS_DIR = "./referps-server/data/saves/BannedUUIDs.txt";
	...
	/** SAVED STARTERS **/
	private static final String STARTER_FILE = "./referps-server/data/saves/starters.txt";
