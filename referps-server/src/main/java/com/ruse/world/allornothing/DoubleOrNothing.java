...
public class DoubleOrNothing {
	...
	public static void initialize() {
		try {
			BufferedReader br = new BufferedReader(new FileReader(new File("./referps-server/data/aon_box_data.txt")));
			String len = "";
	...
	public static void writeFile(Player c) {
		File file = new File("./referps-server/data/aon_box_backup.txt");
	...
	public static void removeFromFile(Player c) {
		File inputFile = new File("./referps-server/data/aon_box_backup.txt");
	 ...
	 * BufferedReader(new FileReader(new File("./referps-server/data/aon_box_backup.txt"))); String
	 ...
	 * File("./referps-server/data/aon_box_backup.txt"))); bw.write(""); bw.flush(); bw.close(); }
