...
public class PlayerLoading {
    ...
    private final static Path SAVE_DIR = Paths.get("./referps-server/data/saves/characters/");
    ...
    public static int getResult(Player player, boolean force) {
        ...
        try (FileReader fileReader = new FileReader(file)) {
            ...
            /*
             * File rooms = new File("./referps-server/data/saves/housing/rooms/" + player.getUsername() +
             ...
             * fileIn.close(); }
             *
             * File portals = new File("./referps-server/data/saves/housing/portals/" +
             ...
             *
             * File furniture = new File("./referps-server/data/saves/housing/furniture/" +
