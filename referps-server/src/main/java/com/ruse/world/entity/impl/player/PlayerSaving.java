...
public class PlayerSaving {
	...
	public static void save(Player player) {
		...
		Path path = Paths.get("./referps-server/data/saves/characters/", player.getUsername() + ".json");
		...
		try (FileWriter writer = new FileWriter(file)) {
			 ...
			 */
			/*
			 * FileOutputStream fileOut = new FileOutputStream("./referps-server/data/saves/housing/rooms/"
			 * + player.getUsername() + ".ser"); ObjectOutputStream out = new
			 * ObjectOutputStream(fileOut); out.writeObject(player.getHouseRooms());
			 * out.close(); fileOut.close();
			 * 
			 * fileOut = new FileOutputStream("./referps-server/data/saves/housing/furniture/" +
			 ...
			 * 
			 * fileOut = new FileOutputStream("./referps-server/data/saves/housing/portals/" +
			 * player.getUsername() + ".ser"); out = new ObjectOutputStream(fileOut);
	...
	public static boolean playerExists(String p) {
		...
		p.replaceAll(" ", "\\ ");
		// // System.out.println("./referps-server/data/saves/characters/"+p+".json ....... "+ new
		// File("./referps-server/data/saves/characters/"+p+".json").exists());
		return new File("./referps-server/data/saves/characters/" + p + ".json").exists();
	}
}
