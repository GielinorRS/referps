...
public class PlayerPunishment {
	...
	private static final String BAN_DIRECTORY = "./referps-server/data/saves/";
	private static final String JAIL_DIRECTORY = "./referps-server/data/saves/";
	private static final String MUTE_DIRECTORY = "./referps-server/data/saves/";
