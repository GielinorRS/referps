...
public class PassRewards {
	...
	public static final String INFO_FILE_PATH = "./referps-server/data/saves/seasonpass/info.txt";
	public static final String REWARDS_FILE_PATH = "./referps-server/data/saves/seasonpass/memberRewards.txt";
	public static final String DEFAULT_REWARDS_FILE_PATH = "./referps-server/data/saves/seasonpass/defaultRewards.txt";
