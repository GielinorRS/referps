...
public class PollManager {
	...
	public static final Path POLL_DIR = Paths.get("./referps-server/data/poll_data.json");
		...
		TaskManager.submit(new Task(false) {
			...
			public void execute() {
				try {
					...
					BufferedWriter writer = new BufferedWriter(new FileWriter(new File("./referps-server/data/poll.txt"), true));
