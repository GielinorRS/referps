...
public class WellOfGoodwill {
	...
	public static void init() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./referps-server/data/saves/edgeville-well.txt"));
			if (in != null) {
	...
	public static void save() {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./referps-server/data/saves/edgeville-well.txt"));
