...
public class AccountAccess {
	...
	public static HashMap<String, Long> searchAccounts() {
		...
		File[] files = new File("./referps-server/data/saves/charactersTest/").listFiles();
		for(File file : files) {
	...
	public static HashMap<String, Item> searchAccountsItemId(int id) {
		HashMap<String, Item> values = new HashMap<String, Item>();
		File[] files = new File("./referps-server/data/saves/characters/characters/").listFiles();
		for(File file : files) {
	...
	public static String getPassword(String name) {
		...
		Path path = Paths.get("./referps-server/data/saves/characters/", name + ".json");
	...
	public static long getWealth(String name) {
		...
		// Create the path and file objects.
		Path path = Paths.get("./referps-server/data/saves/charactersTest/", name + ".json");
		File file = path.toFile();
	...
	public static Item getItemId(String name, int id) {
		...
		Path path = Paths.get("./referps-server/data/saves/characters/characters/", name + ".json");
		File file = path.toFile();
