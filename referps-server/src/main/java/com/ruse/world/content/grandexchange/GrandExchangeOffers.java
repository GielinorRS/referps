...
public class GrandExchangeOffers {
	...
	public static void init() {
		try {
			File file = new File("./referps-server/data/saves/GE/offers.dat");
			if (!file.exists()) {
				return;
			}
	...
	public static void save() {
		try {
			...
			DataOutputStream out = new DataOutputStream(new FileOutputStream("./referps-server/data/saves/GE/offers.dat", false));
