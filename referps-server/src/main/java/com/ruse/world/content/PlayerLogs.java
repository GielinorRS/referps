...
public class PlayerLogs {
	...
	private static final String NPC_COORDS = "./referps-server/data/saves/";
	private static final String FILE_PATH = "./referps-server/data/saves/logs/";
	private static final String FILE_PATH_LOGS = "./referps-server/data/saves/logs/other/";
	private static final String WORLD_FILE_PATH = "./referps-server/data/saves/worldlogs/";
