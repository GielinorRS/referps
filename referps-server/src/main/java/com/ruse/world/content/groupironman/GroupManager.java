...
public class GroupManager {
    ...
    public static int getNextId() {
        ...
        try {
            BufferedReader r = new BufferedReader(new FileReader("./referps-server/data/saves/groupID.txt"));
        ...
        try {
            BufferedReader file = new BufferedReader(new FileReader("./referps-server/data/saves/groupID.txt"));
            ...
            FileOutputStream fileOut = new FileOutputStream("./referps-server/data/saves/groupID.txt");
