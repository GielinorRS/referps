...
public final class RegionClipping {
	...
	public static void init() {
		try {
			...
			final File file = new File("./referps-server/data/clipping/map_index");
	...
	public static void loadRegion(int x, int y) {
		...
		try {
			...
			byte[] objectData = Misc.getBuffer(new File("./referps-server/data/clipping/maps/" + mapObjects + ".gz"));
			byte[] groundData = Misc.getBuffer(new File("./referps-server/data/clipping/maps/" + mapGround + ".gz"));
