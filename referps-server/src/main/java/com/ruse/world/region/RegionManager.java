...
public final class RegionManager {
    ...
    public static void initialise() {
        ...
        for (int regionId : regionIds) {
            ...
            try {
                byte[] locData = Misc.getBuffer(new File("./referps-server/data/clipping/maps/" + ids.getRight() + ".gz"));
                byte[] mapData = Misc.getBuffer(new File("./referps-server/data/clipping/maps/" + ids.getLeft() + ".gz"));
